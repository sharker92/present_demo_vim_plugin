vim.opt.rtp:append("/Users/sharker/.config/nvim/lua/plugins/present.nvim/")
-- vim.keymap.set("n", "<leader>qq", "<cmd>PlenaryBustedFile %<CR>")
...
describe("present.parse_slides", function()
	...
	it("should parse a file with one slide", function()
		eq(
			{
				slides = {
					{ title = "# This is the first slide", body = { "This is the body" }, blocks = {} },
				},
			},
			parse({
